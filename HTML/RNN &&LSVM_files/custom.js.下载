...
var custom = (function() {
  ...
  function itemMouseOver(item) {
    var itemCTATxt = item.querySelector('.' + elementClass_.itemCTATxt);
    itemCTATxt.style.color = '#666666';
    item.style.borderColor = "rgb(223, 223, 223)";
  }
